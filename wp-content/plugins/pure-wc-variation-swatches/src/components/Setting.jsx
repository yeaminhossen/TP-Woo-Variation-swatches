          ...
          <div className="tpv-settings-tab-content bg-white rounded-xl rounded-tl-none">
            ...
            {settingActive === "shop-archive" && (
              <div className="tpv-settings-shop">
                ...
                {/* <div className="tpv-settings-option md:flex justify-between items-center pt-[26px] pb-[23px] px-9 border-[#F4F5F9] border-b-2 last:border-0">
                  <div className="tpv-settings-option-content mb-4 md:mb-0">
                    <h4 className="text-lg mb-0">Product Wrapper Selector</h4>
                    <p className="mb-0">
                      Archive product wrapper selector. Default:{" "}
                      <code className="bg-[#F7F9FA] text-[#303136] h-7 px-2 inline-block">
                        .product
                      </code>
                    </p>
                ...
                {/* <div className="tpv-settings-option md:flex justify-between items-center pt-[26px] pb-[23px] px-9 border-[#F4F5F9] border-b-2 last:border-0">
                  <div className="tpv-settings-option-content mb-4 md:mb-0">
                    <h4 className="text-lg mb-0">Image Selector</h4>
                    <p className="mb-0">
                      Archive product image selector to show variation image.
                      Default:{" "}
                      <code className="bg-[#F7F9FA] text-[#303136] h-7 px-2 inline-block">
                        .attachment -woo commerce_thumbnail
                      </code>
                    </p>
                  </div>
                ...
                {/* <div className="tpv-settings-option md:flex justify-between items-center pt-[26px] pb-[23px] px-9 border-[#F4F5F9] border-b-2 last:border-0">
                  <div className="tpv-settings-option-content mb-4 md:mb-0">
                    <h4 className="text-lg mb-0">Add to cart text selector</h4>
                    <p className="mb-0">
                      Archive add to cart button text selector. Default:{" "}
                      <code className="bg-[#F7F9FA] text-[#303136] h-7 px-2 inline-block">
                        .add_to_cart_button
                      </code>
                    </p>
