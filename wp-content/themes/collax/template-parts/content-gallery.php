...
<article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item format-gallery transition-3' );?>>
    ...
    <?php else: ?>
        ...
        <article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item format-gallery mb-50 transition-3 fix' );?>>
