<?php
    ...
    $author_info = get_the_author_meta( 'collax_write_by');
    $facebook_url = get_the_author_meta( 'collax_facebook' );
    $twitter_url = get_the_author_meta( 'collax_twitter' );
    $linkedin_url = get_the_author_meta( 'collax_linkedin' );
    $instagram_url = get_the_author_meta( 'collax_instagram' );
    $collax_url = get_the_author_meta( 'collax_youtube' );
    $collax_write_by = get_the_author_meta( 'collax_write_by' );
