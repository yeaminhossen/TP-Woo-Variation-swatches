...
<header class="d-none d-lg-block">
    <div id="header-sticky" class="tp-header-area-two wp-header-6 tp-header-bs-area header-space-three pt-35">
                ...
                <div class="col-xxl-4 col-xl-3 col-lg-3">
                    <div class="tp-header-left d-flex align-items-center justify-content-end ">
                        <ul class="d-none d-xxl-block">
                            ...
                            <li><a href="<?php echo esc_url($collax_acc_button_link);?>"><i class="far fa-user fa-user"></i> <?php echo esc_html($collax_acc_button_text);?></a></li>
                            <?php endif; ?>

                            <?php if(!empty($collax_header_lang)) : ?>
                              <?php echo collax_header_lang_defualt();?>
                            <?php endif; ?>
                        ...
                        <div class="tp-header-yellow-button">
                            <a class="tp-btn-sky" href="<?php echo esc_url($collax_button_link);?>"><?php echo esc_html($collax_button_text);?></a>
                        </div>
                        <?php endif; ?>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 col-6">
                <div class="tp-header-right z-index-1 d-flex align-items-center justify-content-end">
                    <?php if(!empty($collax_header_right) && !empty($collax_button_text)) : ?>
                     <a class="tp-btn-yellow d-none d-md-block" href="<?php echo esc_url($collax_button_link);?>"><?php echo esc_html($collax_button_text);?></a>
                    <?php endif; ?>
