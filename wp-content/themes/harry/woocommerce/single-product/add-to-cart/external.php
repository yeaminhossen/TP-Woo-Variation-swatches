...
<form class="cart" action="<?php echo esc_url( $product_url ); ?>" method="get">
	...
	<button type="submit" class="single_add_to_cart_button product-add-cart-btn product-add-cart-btn-3 button alt<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
