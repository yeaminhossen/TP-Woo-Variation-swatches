						...
						<?php
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									...
									esc_attr__( 'Remove this item', 'harry' ),
									esc_attr( $product_id ),
...
<?php else : ?>
   ...
   <div class="cartmini__empty text-center">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/cartmini/empty-cart.png" alt="<?php echo esc_attr__('empty-cart', 'harry'); ?>">
      <p class="woocommerce-mini-cart__empty-message">
      	<?php esc_html_e( 'No products in the cart.', 'harry' );?>
      </p>	
      <a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" class="tp-btn"><?php esc_html_e( 'Go to Shop', 'harry' );?></a>
   </div>
