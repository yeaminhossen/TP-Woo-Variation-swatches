...
function harry_register_required_plugins() {
     ...
     */
     ...
     $url = 'https://weblearnbd.net/wp/harry/source/';
    ...
    $plugins = [
        ...
        [
            'name'               => esc_html__('WPZOOM Social Feed Widget & Block','harry'),
            'slug'               => 'instagram-widget-by-wpzoom',
            'required'           => false, 
        ],
        [
            'name'               => esc_html__('Event Manager','harry'),
