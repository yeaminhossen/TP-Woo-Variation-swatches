...
$footer_bg_color = get_theme_mod( 'harry_footer_bg_color', '#0D121E' );
...
?>
      ...
      <!-- footer area start -->
      <footer>
         <div class="footer__area p-relative z-index-1" data-bg-color="<?php print esc_attr( $bg_color );?>">
            <div class="footer__bg" data-background="<?php print esc_url( $bg_img );?>"></div>
               ...
               <div class="container">
                  <div class="row">
                    <?php
                        ...
                        print '<div class="col-xxl-4 col-xl-3 col-lg-3 col-md-6 col-sm-6">';
