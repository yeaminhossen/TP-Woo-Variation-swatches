...
$footer_bg_color = get_theme_mod( 'harry_footer_bg_color', '#1F2235' );
            ...
            <div class="footer__top footer__top-8">
               <div class="container">
                  <div class="row">
                        <?php
                            if ( $footer_columns < 5 ) {
                            print '<div class="col-xxl-3 col-xl-3 col-lg-4 col-sm-6">';
                            ...
                            print '<div class="col-xxl-2 col-xl-2 col-lg-4 col-sm-5">';
                            dynamic_sidebar( 'footer-7-3' );
                            print '</div>';

                            print '<div class="col-xxl-4 col-xl-4 col-lg-5 col-sm-7">';
