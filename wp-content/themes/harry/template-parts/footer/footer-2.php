...
$footer_bg_color = get_theme_mod( 'harry_footer_bg_color', '#022B26');
$footer_top_space = get_theme_mod( 'harry_footer_top_space' );
...
// footer space
$footer_space = !empty( $harry_footer_top_space ) ? $harry_footer_top_space : $footer_top_space;
