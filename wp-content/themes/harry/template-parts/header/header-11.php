<?php 
   ...
   $harry_menu_col = $harry_header_right ? 'col-xxl-6 col-xl-6 col-lg-8 d-none d-lg-block' : 'col-xxl-9 col-xl-10 col-lg-10 col-md-8 col-sm-7 col-4 text-end';
...
?>
      ...
      <header>
         <div class="header__area header__transparent">
            ...
            <div class="header__bottom-10 <?php echo esc_attr($enable_sticky) ?>" id="header-sticky">
               <div class="container">
                  <div class="mega-menu-wrapper p-relative">
                     <div class="row align-items-center">
                        ...
                        <div class="<?php echo esc_attr($harry_menu_col);?>">
                           <div class="main-menu main-menu-10 main-menu-ff-space">
                              ...
                              <div class="header__hamburger ml-50 d-lg-none">
                                 <button type="button" class="hamburger-btn hamburger-btn-red offcanvas-open-btn">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                 </button>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-8 col-sm-7 col-4">
                           <div class="header__bottom-right d-flex justify-content-end align-items-center">
                              ...
                              <div class="header__btn-10 ml-30 d-none d-sm-block">
                                 <a href="<?php echo esc_url($harry_contact_button_link); ?>" class="tp-header-btn-3"><?php echo esc_html($harry_contact_button_text); ?></a>
                              </div>
                              <?php endif; ?>
