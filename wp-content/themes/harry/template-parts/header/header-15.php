<?php 
   ...
   if($is_it_transparent_header && !$harry_transparent_header) :
      $harry_transparent_enable = 'header__transparent header__white-solid header__white-solid-2'; 
      $harry_transparent_logo = true;

   
   // if transparent set from acf
   elseif($is_it_transparent_header && $harry_transparent_header) :
      $harry_transparent_enable = 'header__white-solid header__white-solid-2';
      $harry_transparent_logo = false;

   // style from customizer
   else :
      $harry_transparent_enable = $harry_transparent_header ? 'header__transparent header__white-solid header__white-solid-2' : 'header__white-solid header__white-solid-2';
...
?>
   ...
   <header>
      <div class="header__area <?php echo esc_attr($harry_transparent_enable); ?>">
         <div class="header__bottom <?php echo esc_attr($enable_sticky) ?>" id="header-sticky">
            <div class="container">
